...
- [ ] Auditoria de sistema (Jul/2026) identificou várias sobreposições de funcionalidade — progresso da unificação faseada:
  ...
  - [ ] Communication Center / Email Marketing / Strategic Planner como 3 fluxos de campanha não integrados
  ...
  - [ ] App da paciente com páginas sem link de acesso (`/patient/recipes`, `/patient/scanner`, `/patient/ranking` standalone)
