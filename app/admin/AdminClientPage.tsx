...
const navGroups: NavGroup[] = [
    ...
    { id: 'intelligence', icon: Bot, label: 'Inteligência e ajustes', items: [
        ...
        { id: 'settings', label: 'Configurações do clube' }, { href: '/admin/integrations', label: 'Integrações' },
    ]},
]
    ...
    return (
        <div className="min-h-screen bg-[#F4F7F6] text-[#1C2B27] flex">
            <aside style={{ width: sidebarWidth }} className="fixed inset-y-0 left-0 z-50 flex flex-col bg-white border-r border-[#D3DEDB] shadow-[6px_0_28px_rgba(28,43,39,0.04)] transition-[width] duration-200">
                ...
                {!collapsed && <div className="border-t border-[#E0E8E6] p-3"><Link href="/admin/integrations" className="flex items-center gap-3 rounded-xl border border-[#B8DED5] bg-[#F1F9F7] px-3 py-3 text-[#0D7166] hover:bg-[#E2F3EF] transition-colors"><SlidersHorizontal size={17} /><div className="min-w-0"><p className="text-xs font-black">Chaves e integrações</p><p className="text-[10px] text-[#5E726D] mt-0.5">Conectar, testar e monitorar</p></div></Link></div>}
            </aside>
