...
// Metas (Goals) foram movidas para a Biblioteca Clínica (ADR-0001 — Metas são
// um Ativo Clínico independente, não pertencem exclusivamente a Protocolos).
// Ver app/admin/views/ClinicalLibraryView.tsx.
type Tab = 'protocols' | 'meals' | 'challenges' | 'seasonal'
