    ...
    return (
        <div className="pb-24 pt-6 px-4 max-w-md mx-auto min-h-screen">
            <div className="mb-8 text-center">
                ...
                <p className="text-sm text-gray-400">Protocolo: <span className="text-queen-pink font-medium">Desafio 21 Dias</span></p>
            </div>

            <div className="space-y-8 relative">
                {/* Connecting Line (Absolute centered) */}
                <div className="absolute left-[27px] top-10 bottom-0 w-0.5 bg-gradient-to-b from-queen-pink via-purple-500 to-transparent opacity-30 z-0" />
                ...
                {weeks.map((week, wIndex) => (
                    <div key={wIndex} className="relative z-10 mb-10">
                        ...
                        <div className="flex items-center gap-3 mb-6 bg-black/40 backdrop-blur rounded-xl p-3 border border-white/5 mx-auto w-fit shadow-lg">
                            {week.locked ? <Lock size={16} className="text-gray-500" /> : <Zap size={16} className="text-crown-gold" />}
                                ...
                                <div key={dIndex} className="flex items-center group">
                                    ...
                                    <div className="relative mr-4 pl-1">
                                        <div className={cn(
                                            ...
                                            day.status === 'completed' ? "bg-queen-pink border-queen-pink text-white shadow-[0_0_15px_rgba(255,20,147,0.5)]" :
                                                day.status === 'active' ? "bg-white border-queen-pink text-queen-pink scale-110 shadow-[0_0_20px_rgba(255,255,255,0.4)]" :
                                    ...
                                    <div className={cn(
                                        ...
                                        day.status === 'active' ? "glass-panel border-queen-pink/50 translate-x-1 bg-white/5" :
                                        ...
                                        <div className="flex justify-between items-start mb-1">
                                            ...
                                            {day.status === 'active' && <span className="text-[10px] bg-queen-pink px-2 py-0.5 rounded-full text-white font-bold animate-pulse">HOJE</span>}
                                        </div>
                                        ...
                                        {day.status === 'active' && (
                                            <button className="mt-3 text-xs flex items-center gap-1 text-queen-pink font-bold hover:underline">
